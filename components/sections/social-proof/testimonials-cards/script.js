(function () {
   ...
   * Busca prev/next em qualquer lugar dentro do [data-js="testimonials"],
   * permitindo que as setas fiquem no header OU no rodapé.
   */
  document.querySelectorAll('[data-js="testimonials"]').forEach(function (section) {
